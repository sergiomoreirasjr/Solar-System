...
Title.propTypes = {
  headline: PropTypes.string, // 1: https://reactjs.org/docs/typechecking-with-proptypes.html
}.isRequired;
...
Inicialmente eu tinha importado o Title para o App, mas não é um requisito da questão então eu exclui a importação.
*/
